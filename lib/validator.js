...
class Validator {
    ...
    async run (m) {
        ...
        // this.addCommandHooks(config) // not needed in validator

        // remove hooks from config
        config.before = config.beforeValidator
        config.after = config.afterValidator
        config.beforeCommand = () => {}
        config.afterCommand = () => {}
        config.beforeHook = () => {}
        config.afterHook = () => {}
        config.beforeSuite = () => {}
