...
class ConfigParser {
    ...
    extractExecutionFilterArgs (object = {}) {
        if (!this._config.executionFilters) {
            this._config.executionFilters = {}
        }

        function addFilter (filterKey, target) {
            if (typeof object[filterKey] !== 'undefined') {
                target[filterKey] = JSON.parse(object[filterKey])
            }
        }

        addFilter('specs', this._config.executionFilters)
        addFilter('testcases', this._config.executionFilters)
        addFilter('listFiles', this._config.executionFilters)
        addFilter('specFiles', this._config.executionFilters)
        addFilter('testcaseFiles', this._config.executionFilters)

        delete object.specs
        delete object.testcases
     ...
     */
    merge (object = {}) {
        const orSpecs = object.specs
        const orTestcases = object.testcases
        ...
        if (typeof this._config.executionFilters.specFiles !== 'undefined') {
            ...
            for (let spec of this._config.executionFilters.specFiles) {
        ...
        if (typeof this._config.executionFilters.testcaseFiles !== 'undefined') {
            ...
            for (let testcase of this._config.executionFilters.testcaseFiles) {
        ...
        object.specs = orSpecs
        object.testcases = orTestcases
    }
