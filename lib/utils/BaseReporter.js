...
class BaseReporter extends events.EventEmitter {
    ...
    getSuitesSummary () {
        ...
        if (this.startedSpecs) {
            output += 'Number of Spec Files: ' + Object.keys(this.config.executionFilters.specFiles).length + '\n'
            output += 'Number of Specs: ' + Object.keys(this.config.executionFilters.specs).length + '\n'
        } else {
            output += 'Number of Testcase Files: ' + Object.keys(this.config.executionFilters.testcaseFiles).length + '\n'
            output += 'Number of Testcases: ' + Object.keys(this.config.executionFilters.testcases).length + '\n'
        }
    ...
    epilogue () {
        ...
        if (this.startedSpecs) {
            if (!this.printEpilogue) {
                if (!this.resetPrintEpilogueOnce) {
                    this.printEpilogue = true
                } else {
                    this.resetPrintEpilogueOnce = true
                }
            }
        }
        ...
        console.log(this.getSuitesSummary())
        ...
        if (this.startedSpecs) {
            ...
            fmt = this.color('green', '%d passing')
